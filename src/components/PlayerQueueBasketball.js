                  ...
                  return (
                    ...
                    >
                      <div className="player-info">
                        ...
                        <span className={`player-name ${compactMode !== 'normal' ? compactMode : ''}`}>{player.name}{firstGamePlayed && player.gamesPlayed === 0 && (<span title="Hasn't played yet" style={{marginLeft: 4}}>✨</span>)}</span>
                      </div>
...
export default PlayerQueueBasketball; 